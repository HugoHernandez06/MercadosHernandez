...
namespace MercadosHernandez.Controllers
{
    public class PropietariosController : Controller
    {
        ...
        public PropietariosController(MercadosHernandezContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,Telefono")] Propietario propietario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellido,Telefono")] Propietario propietario)
        {
